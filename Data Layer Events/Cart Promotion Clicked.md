...
|ecommerce.promotion_id|string|The ID of the promotion associated with the event.||||||||
|ecommerce.promotion_name|string|The name of the promotion associated with the event.||||||||
