...
dataLayer.push({
  ...
  "detailed_event": "Product Comparison Viewed",
    "ecommerce": {
        ...
        "items_compared_together": "<items_compared_together>"
    }
});
```
...
|ecommerce.items_compared_together|string|Captures a concatenated list of product names \/ ids that are compared together.|PRDI344\|PRDI432\|PRDI4343, 3443\|5869\|5422, TL434\|TL643|||||||
